...
from claudio.tasks.task_store import SQLiteTaskStore
from claudio.tasks.executor import run_subtask_agent
from claudio.tasks.planner import create_plan
from claudio.tasks.approval import present_plan_for_approval
from claudio.tasks.recovery import RecoveryManager
from claudio.context.indexers.factory import get_indexer
...
async def handle_plan_command(goal: str) -> None:
   ...
   """
   db_path = config.get("tasks", {}).get("db_path", ".claudio/tasks.db")
